...
public class TreeSet<E> extends AbstractSet<E> implements NavigableSet<E>, Cloneable, java.io.Serializable {
	 ...
	 * {@code e1} and {@code e2} in the set. If the user attempts to add an element to the set
	 * that violates this constraint (for example, the user attempts to add a string element to
	 * a set whose elements are integers), the {@code add} call will throw a
	 ...
	 * comparator: {@code comparator.compare(e1,
	 * e2)} must not throw a {@code ClassCastException} for any elements {@code e1} and
	 * {@code e2} in the set. If the user attempts to add an element to the set that violates
	 ...
	 * set must implement the {@link Comparable} interface. Furthermore, all such elements must
	 * be <i>mutually comparable</i>: {@code e1.compareTo(e2)} must not throw a
	 ...
	 * the specified element {@code e} to this set if the set contains no element {@code e2}
	 * such that <tt>(e==null&nbsp;?&nbsp;e2==null&nbsp;:&nbsp;e.equals(e2))</tt>. If this set
	 * already contains the element, the call leaves the set unchanged and returns {@code false}
	 * .
	 * 
	 * @param e
	 ...
	 * <tt>(o==null&nbsp;?&nbsp;e==null&nbsp;:&nbsp;o.equals(e))</tt>, if this set contains such
	 * an element. Returns {@code true} if this set contained the element (or equivalently, if
	 * this set changed as a result of the call). (This set will not contain the element once
	 * the call returns.)
	 * 
	 * @param o
	 ...
	 * @throws NullPointerException
	 * if the specified collection is null or if any element is null and this set uses natural
	 ...
	 * {@inheritDoc}
	 * @throws NullPointerException
	 * if {@code fromElement} or {@code toElement} is null and this set uses natural ordering,
	 ...
	 * {@inheritDoc}
	 * @throws NullPointerException
	 * if {@code toElement} is null and this set uses natural ordering, or its comparator does
	 ...
	 * {@inheritDoc}
	 * @throws NullPointerException
	 * if {@code fromElement} is null and this set uses natural ordering, or its comparator does
	 * not permit null elements
	 * @throws IllegalArgumentException
	 * {@inheritDoc}
	 * @since 1.6
	 ...
	 * elements it contains) (int), followed by all of its elements (each an Object) in order
	 * (as determined by the set's Comparator, or by the elements' natural ordering if the set
	 * has no Comparator).
	 */
