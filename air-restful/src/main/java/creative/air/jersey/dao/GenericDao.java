...
public class GenericDao<T, ID extends Serializable> extends JpaDaoSupport {
    ...
    @SuppressWarnings("rawtypes")
    List<Object> findObjectsByQueryString(final String queryString, final Object... values) {
        Assert.hasText(queryString);
        return getJpaTemplate().executeFind(new JpaCallback() {
            public Object doInJpa(EntityManager em) throws PersistenceException {
    ...
    @SuppressWarnings("rawtypes")
    List<Object> findByNativeQueryString(final String queryString, final Object... values) {
        return getJpaTemplate().executeFind(new JpaCallback() {
            public Object doInJpa(EntityManager em) throws PersistenceException {
    ...
    @SuppressWarnings("rawtypes")
    <K> List<K> findByNativeQueryString(final String queryString, final Class<K> className, final Object... values) {
        return getJpaTemplate().executeFind(new JpaCallback() {
            public Object doInJpa(EntityManager em) throws PersistenceException {
    ...
    Query createQuery(EntityManager em, String queryString, Object... values) {
    ...
    Query createNativeQuery(EntityManager em, String queryString, Object... values) {
    ...
    <K> Query createNativeQuery(EntityManager em, String queryString, Class<K> className, Object... values) {
